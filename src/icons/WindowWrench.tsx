import WindowWrench16FilledSvg from "@fluentui/svg-icons/icons/window_wrench_16_filled.svg" with { type: "text" }
import WindowWrench16RegularSvg from "@fluentui/svg-icons/icons/window_wrench_16_regular.svg" with { type: "text" }
import WindowWrench20FilledSvg from "@fluentui/svg-icons/icons/window_wrench_20_filled.svg" with { type: "text" }
import WindowWrench20RegularSvg from "@fluentui/svg-icons/icons/window_wrench_20_regular.svg" with { type: "text" }
import WindowWrench24FilledSvg from "@fluentui/svg-icons/icons/window_wrench_24_filled.svg" with { type: "text" }
import WindowWrench24RegularSvg from "@fluentui/svg-icons/icons/window_wrench_24_regular.svg" with { type: "text" }
import WindowWrench28FilledSvg from "@fluentui/svg-icons/icons/window_wrench_28_filled.svg" with { type: "text" }
import WindowWrench28RegularSvg from "@fluentui/svg-icons/icons/window_wrench_28_regular.svg" with { type: "text" }
import WindowWrench32FilledSvg from "@fluentui/svg-icons/icons/window_wrench_32_filled.svg" with { type: "text" }
import WindowWrench32RegularSvg from "@fluentui/svg-icons/icons/window_wrench_32_regular.svg" with { type: "text" }
